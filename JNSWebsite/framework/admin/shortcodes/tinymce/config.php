...
$livemesh_shortcodes['video_showcase'] = array(
    ...
    'shortcode' => '[video_showcase id="{{id}}" class="{{class}}" video_id="{{video_id}}" mp4_url="{{mp4_url}}" ogg_url="{{ogg_url}}" webm_url="{{webm_url}}" placeholder_url="{{placeholder_url}}" title="{{title}}" subtitle="{{subtitle}}" muted="{{muted}}" loop="{{loop}}" autoplay="{{autoplay}}" preload="{{preload}}" overlay_pattern="{{overlay_pattern}}" overlay_color="{{overlay_color}}" overlay_opacity="{{overlay_opacity}}"]',
...
$livemesh_shortcodes['video_section'] = array(
    ...
    'shortcode' => '[video_section id="{{id}}" class="{{class}}" video_id="{{video_id}}" mp4_url="{{mp4_url}}" ogg_url="{{ogg_url}}" webm_url="{{webm_url}}" placeholder_url="{{placeholder_url}}" text="{{text}}" subtitle="{{subtitle}}" button_text="{{button_text}}" button_url="{{button_url}}" muted="{{muted}}" loop="{{loop}}" autoplay="{{autoplay}}" preload="{{preload}}" overlay_pattern="{{overlay_pattern}}" overlay_color="{{overlay_color}}" overlay_opacity="{{overlay_opacity}}"]',
    ...
    'params' => array(
        'post_type' => array(
            ...
            'options' => array(
                ...
                'news' => __('News', 'livemesh'),
                'course' => __('Course', 'livemesh'),
                'department' => __('Department', 'livemesh'),
                'staff' => __('Staff', 'livemesh'),
                'sfwd-courses' => __('LearnDash Course', 'livemesh')
            )
        ),
        'title' => array(
            'std' => '',
        ...
        'post_ids' => array(
            'std' => '',
            'type' => 'text',
            'label' => __('Post IDs', 'livemesh'),
            'desc' => __('A comma separated post ids of the custom post types. Helps to filter the post types for display (optional).', 'livemesh')
        ),
        'image_size' => array(
            'std' => 'medium',
            'type' => 'select',
        ...
        'show_meta' => array(
            ...
            'desc' => __(' Display post meta information like the author, date of publishing and number of comments', 'livemesh'),
            'options' => array(
                'false' => __('false', 'livemesh'),
                'true' => __('true', 'livemesh')
            )
        ...
        'taxonomy' => array(
            ...
            'options' => array(
                ...
                'news_category' => __('News Category', 'livemesh'),
                'course_category' => __('Course Category', 'livemesh'),
                'specialization' => __('Staff Specialization', 'livemesh'),
                'category' => __('LearnDash Course Category', 'livemesh')
            )
        ),
        'terms' => array(
            'std' => '',
            ...
            'desc' => __(' A comma separated list of terms of taxonomy specified for which the items needs to be displayed. Helps filter the results by category/taxonomy, if the these terms are defined for the taxonomy chosen.(optional)', 'livemesh')
        ),
        'no_margin' => array(
            'std' => 'false',
            'type' => 'select',
        ...
        'enable_sorting' => array(
            'std' => 'true',
            'type' => 'select',
            'label' => __('Enable Sorting', 'livemesh'),
            'desc' => __(' If set to true, the items are sorted as per the sorting order specified using Post Type Reorder plugin.', 'livemesh'),
            'options' => array(
                'true' => __('True', 'livemesh'),
                'false' => __('False', 'livemesh')
            )
...
$livemesh_shortcodes['animate_numbers'] = array(
    'popup_title' => __('Insert Number Stats Shortcode', 'livemesh'),
    'no_preview' => true,
    'params' => array(
        'icon' => array(
            'std' => 'icon-study',
            ...
            'desc' => __('The font icon to be displayed for the statistic being displayed, chosen from the list of icons listed at http://portfoliotheme.org/support/faqs/how-to-use-1500-icons-bundled-with-the-agile-theme/', 'livemesh'),
        ),
        'title' => array(
            'std' => 'Graduate in 4 years',
            'type' => 'text',
            'label' => __('Stats Title', 'livemesh'),
            'desc' => __('The title indicating the stats title.', 'livemesh'),
        ),
        'text' => array(
            'std' => 'Double the National Average',
            'type' => 'text',
            'label' => __('Text', 'livemesh'),
            'desc' => __('Any additional text shown below the title.', 'livemesh'),
        ),
        'stats' => array(
            'std' => '80%',
            'type' => 'text',
            'label' => __('Stats', 'livemesh'),
            'desc' => __('The stats value to be displayed', 'livemesh'),
        )
    ),
    'shortcode' => '[number-stat icon="{{icon}}" title="{{title}}" text="{{text}}"]{{stats}}[/number-stat] ',
    'popup_title' => __('Add Stats Number', 'livemesh')
);
