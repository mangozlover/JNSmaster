...
if (!class_exists('MO_Framework_Extender')) {
    ...
    class MO_Framework_Extender {
        ...
        function initialize() {
            ...
            if ($show_breadcrumbs) {
                add_action("{$prefix}_before_content", 'mo_display_breadcrumbs', 15);
            }

            add_action("{$prefix}_before_content", 'mo_display_custom_content_below_header', 16);
        ...
        function mo_add_lightbox_hook($content) {
            ...
            $replacement = '<a$1href=$2$3.$4$5 data-gal="prettyPhoto[' . $post->ID . ']"$6>$7</a>';
