...
/* Change Log - _construct function at line number 117 changed to changed path of the class */
  ...
  public function __construct ( $meta_box ) {
    ...
    if (isset($meta_box['use_with_theme'])){
      if ($meta_box['use_with_theme'] === true){
        $this->SelfPath = get_template_directory_uri() . '/framework/extensions/taxonomy-fields';
  ...
  */
  ...
  public function check_field_time() {
    ...
    if ( $this->has_field( 'time' ) && $this->is_edit_page() ) {
      ...
      wp_enqueue_script( 'at-timepicker', 'https://raw.githubusercontent.com/trentrichardson/jQuery-Timepicker-Addon/master/dist/jquery-ui-timepicker-addon.js', array( 'tmc-jquery-ui' ),false,true );
