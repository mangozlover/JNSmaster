            ...
            <div class="hfeed">
                ...
                if (have_posts()) :
                    ...
                    if ($filterable)
                        ...
                        echo mo_get_post_type_archive_links('gallery_item', 'gallery_category');

                    echo '<ul id="showcase-items" class="image-grid ' . $layout_mode . ' js-isotope" data-isotope-options=\'{ "itemSelector": ".showcase-item", "layoutMode": "' . $layout_mode . '" }\'>';
...
if (!function_exists('mo_get_filterable_gallery_content')) {
    function mo_get_filterable_gallery_content($args) {
        ...
        if ($loop->have_posts()) :
            ...
            $output .= '<ul id="showcase-items" class="image-grid ' . $layout_mode . ' js-isotope" data-isotope-options=\'{ "itemSelector": ".showcase-item", "layoutMode": "' . $layout_mode . '" }\'>';
