    ...
    class MO_SidebarManager {
        ...
        private function init_sidebars() {
            $this->sidebar_names = array(
                ...
                'primary-staff' => __('Staff Sidebar', 'mo_theme'),
                'primary-department' => __('Department Sidebar', 'mo_theme'),
                'primary-courses' => __('Courses Sidebar', 'mo_theme'),
                'primary-news' => __('News Sidebar', 'mo_theme'),
                ...
                'primary-ld-courses' => __('LearnDash Course List Sidebar', 'mo_theme'),
                'primary-ld-custom-posts' => __('LearnDash Custom Post Sidebar', 'mo_theme')
            );
            ...
            $this->sidebar_descriptions = array(
                ...
                'primary-staff' => __('Sidebar displayed in staff archive pages', 'mo_theme'),
                'primary-courses' => __('Sidebar displayed in course archive pages', 'mo_theme'),
                'primary-department' => __('Sidebar displayed in department archive pages', 'mo_theme'),
                'primary-news' => __('Sidebar displayed in news archive pages', 'mo_theme'),
                ...
                'primary-ld-courses' => __('Sidebar displayed in pages displaying list of LearnDash courses', 'mo_theme'),
                'primary-ld-custom-posts' => __('Sidebar displayed in pages displaying single LearnDash course, lesson, topic, assignment, quiz or certification etc.', 'mo_theme')
            );
        ...
        function get_sidebar_id_suffix() {
            ...
            elseif (is_post_type_archive('staff') || is_singular('staff') || is_tax('specialization') || is_page_template('template-staff.php'))
                $suffix = 'staff';
            elseif (is_post_type_archive('course') || is_singular('course') || is_tax('course_category') || is_page_template('template-courses.php'))
                $suffix = 'courses';
            elseif (is_post_type_archive('department') || is_singular('department') || is_page_template('template-departments.php'))
                $suffix = 'department';
            elseif (is_post_type_archive('news') || is_singular('news') || is_tax('news_category') || is_page_template('template-news.php'))
                $suffix = 'news';
            elseif (is_post_type_archive('sfwd-courses') || is_page_template('template-ld-courses.php'))
                $suffix = 'ld-courses';
            elseif (is_singular(array('sfwd-courses', 'sfwd-assignment' , 'sfwd-lessons', 'sfwd-quiz', 'sfwd-topic', 'sfwd-certificates')))
                $suffix = 'ld-custom-posts';
