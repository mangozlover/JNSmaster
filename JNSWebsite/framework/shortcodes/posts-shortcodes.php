...
post_ids - Comma separated list of post ids of those posts you want displayed
post_parent - The post id of the parent whose child posts you want displayed
...
no_margin - false (boolean) If set to true, no margins are maintained between the columns. Helps to achieve the popular packed layout.
layout_mode - fitRows (string) - Can be either masonry or fitRows. Decides the layout of the images.
*/
